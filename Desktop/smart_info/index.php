        ...
        <form name="" method="get">
          ...
          <div class="selectbox">
            ...
            <select name="sort">
              ...
              <option value="2" <?php if(getFormData('sort',true) == 3 ){ echo 'selected'; } ?> >スペック順</option>              
            </select>
          </div>
          <input type="submit" value="検索">
          <div>
            <h1 class="title">▫️最新の商品</h1>
          </div>
        </form>
      ...
      <section id="main" >
        <div class="search-title">
          <div class="search-left">
            最新のスマートフォン <span class="total-num"><?php echo sanitize($dbProductData['total']); ?></span>件表示中
          </div>
        ...
        <div class="panel-list">
         <?php
          ...
          ?>
            <a href="productDetail.php<?php echo (!empty(appendGetParam())) ? appendGetParam().'&p_id='.$val['id'] : '?p_id='.$val['id']; ?>" class="panel button" :draggable="true" :resizable="true">
